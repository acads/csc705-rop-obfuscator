...
set title 'cp: Categorized ROP Gadget Count for Unobfuscated and Obfuscated cp Binary'
set key left top
...
plot for [COL=2:3] 'cp.gp.dat' using COL:xticlabels(1) title columnheader fs pattern 2
