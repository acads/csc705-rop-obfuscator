...
#       count gnuplot graph file cp binary.
#
...
set output 'cp-all.eps'

# Set graph title and where to place the keys
set title 'Categorized ROP Gadget Count - cp binary'
set key left top
...
plot for [i=2:6] 'cp-all.gp.dat' using i:xtic(1) ti col ls i
